/**
 * Tavily Search backend for dsh-websearch.
...
import { applyTavilyFilters, normalizeFilters } from "../util/filters.js";
...
export const tavilyBackend = {
  ...
  async search(request, signal, options, hooks) {
    ...
    applyTavilyFilters(body, normalizeFilters(request.filters));
