window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		if (typeof document !== "undefined" && document.querySelector("style[data-plugin-css=\"dsh-websearch/card\"]") === null) {
			...
			tag.dataset.plugin = "dsh-websearch";
		...
		function UnifiedSearchCard(props) {
			...
			if (!state.ready) {
				return react_jsx_runtime.jsx("li", { className: "wsc-card", style: { fontSize: 12, opacity: .6 }, children: "…" });
			}

			const toggleField = (id) => "enable" + id.charAt(0).toUpperCase() + id.slice(1);

			return react_jsx_runtime.jsxs("li", { className: "wsc-card", children: [
